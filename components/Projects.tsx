            ...
            <div className="card-body">
              <div className="lg:flex justify-between items-center flex">
                ...
                <div className="lg:flex lg:items-center lg:justify-between lg:space-x-3 flex space-x-3">
                  ...
                  <Link href="https://noteyy.vercel.app/" target="_blank"><FiExternalLink className="lg:text-xl text-2xl" /></Link>
                </div>                
              </div>                
            ...
            <div className="card-body">
              <div className="lg:flex justify-between items-center flex">
                ...
                <div className="lg:flex lg:items-center lg:justify-between lg:space-x-3 flex space-x-3">
                  ...
                  <Link target="_blank" href="#" onClick={event => event.preventDefault()}><FiExternalLink className="lg:text-xl text-2xl" /></Link>
                </div>   
                </div>             
