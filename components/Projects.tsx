...
const Projects = () => {
  return (
    <div className="w-full flex flex-col lg:space-y-7">
      <div className="lg:flex lg:justify-start lg:items-center justify-center space-x-2">
        <h1 className="lg:text-4xl text-4xl mt-10 py-5 lg:py-0 lg:mt-0">Projects</h1>
