...
<link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@400;500;700&family=Monofett&family=Poppins:wght@400;500;700&display=swap" rel="stylesheet" />      </Head>
      ...
      <main className="lg:h-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[100px_minmax(900px,_1fr)_100px] items-center lg:h-full">
          ...
          className="menu-links hidden lg:flex lg:flex-col lg:items-center lg:space-y-4">
            <ul className="menu rounded-box">
              ...
              <li>
                <Link href="/"><FaSchool className='lg:text-2xl' /></Link>
              </li>
              <li>
            ...
            <div className="lg:h-screen lg:overflow-y-scroll py-7" id="content">
              ...
              <section id="projects" className='lg:h-[88vh] h-screen lg:flex lg:justify-center lg:items-center'>
                <Projects />
              </section> 
              <section id="contact" className='lg:h-[88vh] h-screen lg:flex justify-center items-center'>
                <Contact />
              </section>                       
          </div>
          <motion.div 
